...
def create_block_external_middleware():
    ...
    async def block_external_middleware(request: web.Request, handler):
        ...
        response.headers['Content-Security-Policy'] = "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' blob:; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob:; font-src 'self'; connect-src 'self' data:; media-src 'self' data: blob:; frame-src 'self'; object-src 'self';"
        return response

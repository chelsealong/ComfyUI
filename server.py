...
def resolve_view_media_path(request, user_manager):
    """Resolve /view-style query params (filename, type, subfolder, blake3 asset
    hashes) to an on-disk path with path-traversal containment.

    Returns (file, filename, content_type) on success, or a web.Response error.
    """
